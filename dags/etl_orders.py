...
sql_clear_staging = '''
delete from Staging.dbo.Orders
'''

sql_extract_orders = '''
insert into Staging.dbo.Orders
...
where o.order_date > coalesce((select max(order_date) from DW.dbo.factOrders), cast('1950-01-01' as datetime))
'''
